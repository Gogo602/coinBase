...
import { Search, Triangle, Bitcoin } from "lucide-react";
      ...
      <div className="container mx-auto px-4 py-10">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
          <p className="text-white text-sm font-bold text-center sm:text-left">
            Admin Management Bitcoin & Ethereum
          </p>
        ...
        <div className="mt-16 border border-white rounded-xl p-10 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
          {filteredCards.map((card) => {
            return (
              <div
                key={card.id}
                className={`relative rounded-xl shadow-lg px-6 py-20 flex flex-col items-center justify-center ${card.bg} group`}
              >
                {/* Remove Button */}
                <button
...
export default BitCoinAndEthereum;
