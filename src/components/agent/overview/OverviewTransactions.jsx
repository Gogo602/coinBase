...
const OverviewTransactions = () => {
 ...
 <div>
            ...
            <div className='mt-10'>
               { Data.map((tx, index) => (
                 <div key={`${index ?? 'tx'}-${index}`} className='flex justify-around items-center align-center py-5 border mb-2 rounded-full '>
                   <span>{tx.date}</span>
                   <span>{tx.id}</span>
            ...
            <div className='flex justify-center items-center mt-4'>
                ...
                <div className="md:hidden mt-4 space-y-3">
                  {Data.map((d, i) => (
                    <div key={`mob-${i ?? i}`} className="border p-3 rounded-lg">
